// Real testimonials from Wendy's athletes (condensed from their own words).
// `excerpt` is shown on the home page; `full` (array of paragraphs) on /testimonials.
...
export const TESTIMONIALS = [
  ...
  },
  {
    ...
    full: [
      ...
      "Today we work mostly on trail running — a recent passion of Wendy's — and some swimming. Because of her coaching I've become extremely fit and able to take on the challenges I love: last fall my husband and I did a 10-day European trail-running vacation, then a few weeks later I completed a 25k trail race. None of that would have been possible without Wendy. As I've gotten older, I appreciate her emphasis on the mental side and on always having a 'why' as much as her workout expertise. I'd highly recommend Wendy to anyone seeking a coach!",
    ],
  },
  {
    name: 'Camey',
  ...
  {
    name: 'Payson',
    tag: 'Runner & Triathlete · 12 Years Coached',
    photo: '/photos/trail-running.jpg',
    excerpt:
      "Wendy can coach an Olympic triathlete and someone training for a 5k alike. Her knowledge of training, nutrition, injuries and mental preparation is vast. My biggest challenge is consistency, and she's stuck with me through it all. She is a gem.",
    full: [
      'I met Wendy 12 years ago when my husband found her for me as I trained for a half marathon and worked toward triathlon. At the beginning, I used Wendy to prepare for the Savannah Rock \'n\' Roll Half. Her training was thoughtful, positive, and inspiring.',
      'Over time my goals have changed, and Wendy adapts to them. She can coach an Olympic triathlete and someone training to do a 5k with 20-minute-mile targets. Her knowledge about training, nutrition, managing injuries, and mental preparation is vast. She has analyzed my swim strokes, my gait, and my attitude, and she has innumerable strengthening exercises.',
      "I keep hiring Wendy because I'm hopeful my last four years in my 50s will include a few 70.3 events and another half marathon. My biggest challenge is consistency, and Wendy has stuck with me through some severe mental roadblocks. I could not recommend her more, no matter your level. She is a gem.",
    ],
  },
]
