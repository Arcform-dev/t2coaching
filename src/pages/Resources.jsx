...
function ResourceCard({ r }) {
  const body = (
    <GlassCard style={{ padding: '32px 28px', height: '100%', display: 'flex', flexDirection: 'column' }} className="resource-card">
      ...
      <h3 style={{ fontFamily: "'Hanken Grotesk', system-ui, -apple-system, sans-serif", fontSize: 19, color: '#fff', marginBottom: 12 }}>{r.title}</h3>
    ...
    <GlassCard style={{
      ...
      <div className="story-grid" style={{ display: 'grid', gap: 40, alignItems: 'center' }}>
        <div>
          ...
          <h3 style={{ fontFamily: "'Hanken Grotesk', system-ui, -apple-system, sans-serif", fontSize: 'clamp(1.6rem, 3vw, 2.3rem)', color: '#fff', margin: '14px 0 16px', lineHeight: 1.2 }}>
