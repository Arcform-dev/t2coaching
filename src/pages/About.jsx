            ...
            {PHILOSOPHY.map((p, i) => (
              <Reveal key={p.title} delay={(i % 3) * 0.08}>
                <GlassCard style={{ padding: '32px 28px', height: '100%' }}>
                  <h3 style={{ fontFamily: "'Noto Sans', system-ui, -apple-system, sans-serif", fontSize: 19, color: '#fff', lineHeight: 1.3, marginBottom: 12 }}>
                    {p.title}
                  </h3>
          ...
          <Reveal>
            <a href={WSJ_FEATURE.url} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none', display: 'block' }}>
              <GlassCard style={{ padding: 'clamp(28px, 4vw, 44px)', borderColor: 'rgba(201,168,76,0.35)' }}>
                ...
                <h3 style={{ fontFamily: "'Noto Sans', system-ui, -apple-system, sans-serif", fontSize: 'clamp(1.3rem, 2.4vw, 1.8rem)', color: '#fff', lineHeight: 1.3, marginBottom: 12 }}>
                  "{WSJ_FEATURE.title}"
                </h3>
