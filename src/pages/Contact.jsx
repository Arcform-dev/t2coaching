              ...
              <GlassCard style={{ padding: 'clamp(28px, 4vw, 44px)' }}>
                {status === 'ok' ? (
                  <div style={{ textAlign: 'center', padding: '40px 0' }}>
                    ...
                    <h3 style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: 26, color: '#fff', marginBottom: 12 }}>Message sent!</h3>
                  ...
                  <form onSubmit={submit}>
                    <h2 style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: 24, color: '#fff', marginBottom: 24 }}>Send an inquiry</h2>
            ...
            <Reveal x={40} y={0} delay={0.1}>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
                <GlassCard style={{ padding: '32px 30px' }}>
                  <h3 style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: 20, color: '#fff', marginBottom: 22 }}>Reach me directly</h3>
                ...
                <GlassCard style={{ padding: '32px 30px' }}>
                  <h3 style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontSize: 20, color: '#fff', marginBottom: 8 }}>Prefer to talk?</h3>
