...
export default function Hero() {
  ...
  return (
    <section className="champ-hero">
      ...
      {/* Glass card — short intro + contact button */}
      <div ref={cardRef} className="champ-hero__card">
        <p>Personalized coaching from a Kona world champion, built around your real life and the hours you actually train.</p>
